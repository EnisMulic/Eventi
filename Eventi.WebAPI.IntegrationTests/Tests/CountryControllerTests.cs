...
{
    public class CountryControllerTests : IClassFixture<APIFactory>
    {
        public CountryControllerTests(APIFactory fixture) : base(fixture)
        {
        }
        ...
        public async Task Insert_NameBurkinaFaso_ReturnsStatusCodeCreatedAndCountryBurkinaFaso()
        {
            ...
            var response = await HTTPResponse.Content.ReadAsAsync<CountryResponse>();
            response.Name.Should().Be("Burkina Faso");
        }
        ...
        public async Task Update_ID1NameBurkinaFaso_ReturnsID1NameBurkinaFaso()
        {
            ...
            // Act
            var HTTPResponse = await _httpClient.PutAsync(ApiRoutes.Country.Put.Replace("{id}", "2"), stringContent);
        ...
        public async Task Delete_ID1_ReturnsStatusCodeOK()
        {
            ...
            // Act
            var HTTPResponse = await _httpClient.DeleteAsync(ApiRoutes.Country.Delete.Replace("{id}", "1"));
